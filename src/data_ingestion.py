...
import pandas as pd
import os
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = r"C:\Users\yashw\Downloads\lofty-voyage-461011-f1-24fca73a2409.json"
# ...existing code...
...
class DataIngestion:
    ...
    def download_csv_from_gcp(self):
        try:
            ...
            logger.error(f"Error while downloading the csv file: {e}", exc_info=True)  # Log full error and stack trace
